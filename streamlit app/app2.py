...
# Estilo CSS para el fondo gris suave y otros colores
st.markdown("""
<style>
    .reportview-container {
        background: #E0E0E0;  /* Color de fondo gris suave */
    }
    .sidebar .sidebar-content {
        background: #E0E0E0;  /* Color de fondo de la barra lateral */
    }
    .stApp {
        background-color: #E0E0E0;  /* Color de fondo de la aplicación */
        color: #000000;  /* Color del texto */
    }
    h1 {
        text-align: center;  /* Centrar el título */
        font-size: 4em;  /* Aumentar el tamaño del título */
        color: #40E0D0;  /* Color azul turquesa para el título */
    }
    h2 {
        color: #6B8E23;  /* Color verde oliva para subtítulos */
        text-align: center;  /* Centrar subtítulos */
    }
    h3 {
        color: #F5F5DC;  /* Color beige para otros títulos */
        text-align: center;  /* Centrar otros títulos */
    }
    .footer {
        color: #F5F5DC;  /* Color beige para el pie de página */
    }
    .section-divider {
    ...
    .stButton>button {
        background-color: #40E0D0;  /* Color de fondo de los botones */
        color: white;  /* Color del texto de los botones */
        border: None;  /* Sin borde */
        border-radius: 5px;  /* Bordes redondeados */
        padding: 10px;  /* Espaciado interno */
        font-size: 16px;  /* Tamaño de fuente */
        display: block;  /* Asegura que el botón se centre */
        margin: 0 auto;  /* Centrar el botón */
    }
    .stButton>button:hover {
        background-color: #008B8B;  /* Color al pasar el mouse por encima */
    }
</style>
...
if selection == "Inicio":
    ...
    st.markdown('<h2 style="color: #6B8E23; text-align: center;">Diagrama del Circuito 📷</h2>', unsafe_allow_html=True)
    ...
    **Importancia de ThingSpeak:**
    ...
    if st.button("Ver Video Funcionamiento Prototipo Final"):
        ...
        if st.session_state.show_video_prototipo_final:
            st.video("video funcionamiento prototipo final.mp4")

    if st.button(" Ver Video Armado Prototipo"):
        if 'show_video_armado_prototipo' not in st.session_state:
            st.session_state.show_video_armado_prototipo = False
        st.session_state.show_video_armado_prototipo = not st.session_state.show_video_armado_prototipo
        if st.session_state.show_video_armado_prototipo:
            st.video("video armado prototipo.mp4")
